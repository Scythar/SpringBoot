...
//    @Max(value = 60, message = "User must be below 60")
    ...
    @OneToMany(mappedBy = "user", //It tells Hibernate that the foreign key for this relationship is NOT in this entity (User), but in the child entity (Order) inside the field named 'user'.
